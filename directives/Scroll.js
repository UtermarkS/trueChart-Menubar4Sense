	...
	return qvangular.directive('scrollable', function () {
		return {
			...
			controller: ['$scope', '$element', '$compile', function (scope, element, compile) {
				...
				scope.rail = compile(angular.element('<div class="hico-scroll-rail" ng-style="railStyle"><div class="hico-scroll-dragger"' + ' ng-style="draggableStyle"></div></div>'))(scope);
				...
				watchers.push(scope.$watch(function () {
					return qvangular.$rootScope.tcmenuNoScroll;
				...
				watchers.push(scope.$watch(function () {
					return qvangular.$rootScope.tcmenuCurrentScroll;
				}, function () {
